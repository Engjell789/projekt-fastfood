...
class UserRegistration {
    ...
    public function registerUser($name, $email, $password, $confirm_password, $usertype) {
        if (empty($name) || empty($email) || empty($password) || empty($confirm_password) || empty($usertype)) {
            ...
            $sql = "INSERT INTO users (name, password, email, usertype) 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $userRegistration->registerUser($name, $email, $password, $confirm_password, $usertype);
}
